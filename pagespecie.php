        ...
        <table class="table table-striped table-bordered">
            ...
            <tbody>
                <?php
                    ...
                    $sentencia = $mysqli->prepare("SELECT COUNT(*) as cantidad FROM especies");
                    $sentencia->execute();
                    ...
                    $sentencia = $mysqli->prepare("SELECT * FROM especies LIMIT $offset, $cantidadMaximaElementosPagina");
                    $sentencia->execute();
                    $resultado = $sentencia->get_result();
                    $fila = $resultado->fetch_assoc();
